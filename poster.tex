...
\usepackage[scale=1.25,size=custom,width=91.4,height=121.9,orientation=portrait]{beamerposter}
...
\begin{frame}[t]{}
    ...
    \begin{beamercolorbox}[wd=\textwidth,sep=1em]{}
        ...
        \begin{minipage}[height=0.15\textwidth]{0.3\textwidth}
        \begin{beamercolorbox}[wd=\textwidth,sep=1em]{marvelheader}
            \centering
            \huge
            \textbf{Pillar I/II/III/IV}
        \end{beamercolorbox}
        \end{minipage}
        \hfill
        \begin{minipage}[height=0.15\textwidth]{0.15\textwidth}
    ...
    \begin{beamercolorbox}[wd=\textwidth,sep=1em]{banner}
        ...
        \begin{center}
            ...
            \vspace{1em}
            \large
            Edward Linscott,\textsuperscript{1,2} Riccardo De Gennaro,\textsuperscript{1,2} Nicola Colonna,\textsuperscript{2,3} and Nicola Marzari\textsuperscript{1,2,4}
        \end{center}
    \end{beamercolorbox}

    \vspace{-0.001\paperheight}
    \setbeamercolor{background}{fg=white,bg=seaborn_bg_grey}
    \begin{beamercolorbox}[ht=0.674\paperheight,wd=\textwidth]{background}
